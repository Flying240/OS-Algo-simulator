...
// function addRow() {
//   var lastRow = $('#valueTable tr:last');
//   var lastRowNumebr = parseInt(lastRow.children()[0].innerText);
 
//     var newRow = '<tr><td>'
//     + (lastRowNumebr + 1)
//     + '</td><td><input class="burst-time" type="text"/></td><td class="servtime"></td>'
...
//   $('#valueTable tr:last input').change(function () {
//     recalculateServiceTime();
//   });
// }
...
// function recalculateServiceTime() { 
//   var valueTable = $('#valueTable tr');
//   var totalExectuteTime = 0;

//   var algorithm = $('input[name=algorithm]:checked', '#algorithm').val();
//   if (algorithm == "fcfs") {
//     $.each(valueTable, function (key, value) {
//       if (key == 0) return true;
...
//       $(valueTable[currentIndex + 1].children[2]).text(totalExectuteTime);
